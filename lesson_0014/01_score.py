...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description="Calculate bowling score", prefix_chars="+")
    parser.add_argument('+result', action='store', dest='game_result', type=str)
    args = parser.parse_args()
    _calc_score(args.game_result)
    # data = input("Введите результат игры")
    # _calc_score(data)
