...
for product in goods:
    quantity_prod = 0
    price = 0
    store_item = goods[product]
    for product_item in store[store_item]:
        quantity_prod += product_item['quantity']
        price += product_item['price']
    print(product, '-', quantity_prod, ' шт, общая стоимость ', price, ' руб.')
